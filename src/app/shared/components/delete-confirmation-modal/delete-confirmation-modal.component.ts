...
@Component({
  ...
  template: `
    <div class="delete-confirmation-modal">
      ...
      <div class="delete-confirmation-modal__content">
        <!-- Ícone de atenção -->
        <div class="delete-confirmation-modal__icon-container">
          <mat-icon class="delete-confirmation-modal__warning-icon">warning</mat-icon>
        </div>
        
        <!-- Mensagem principal -->
        <div class="delete-confirmation-modal__message">
          <p class="delete-confirmation-modal__main-text">{{ data.message }}</p>
  ...
  styles: [`
    ...
    // ===== ICON CONTAINER =====
    .delete-confirmation-modal__icon-container {
      margin-bottom: 20px;
      display: flex;
    ...
    // ===== MESSAGE =====
    .delete-confirmation-modal__message {
      display: flex;
